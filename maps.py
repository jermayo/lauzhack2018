...
def setmaptr(GV,main,s,b, player,t):
    ...
    obj.excla(4*s-t*25*s/500,b-1*s,GV).image(main, GV=GV)
    ...
    obj.excla(11*s+(500-t)*25*s/500,b-1*s,GV).image(main, GV=GV)
    obj.clock(9*s+(500-t)*25*s/500,b-1*s,s,GV).image(main)
